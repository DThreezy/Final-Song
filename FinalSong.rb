...
#loop + array of notes
poo = [:e2, :e2, :e2, :e3, :e3, :e3, :e2, :e2, :e2, :e2, :e2, :e3, :e3, :e3, :e2, :e2, :e2, :e2, :e2, :e3, :e3, :e3, :e2, :e2, :e2, :e2, :e2, :e3, :e3, :e3, :e2, :e2]
poopoo = [0.75, 2.5, 0.75, 1, 0.75, 1, 0.75, 1, 0.75, 2.5, 0.75, 1, 0.75, 1, 0.75, 1, 0.75, 2.5, 0.75, 1, 0.75, 1, 0.75, 1, 0.75, 2.5, 0.75, 1, 0.75, 1, 0.75, 1]
num = 0
...
#The 1st song is 01.04.19
#This 2nd song is 01:16.80
#The entire song is 02:20.99
